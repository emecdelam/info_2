...
public class GlobalWarming {
    ...
    static public class IPCCDatabase {
        ...
        HashMap<String,Float> db = new HashMap<>();
        ArrayList<RecordObserver> observers = new ArrayList<>();
        /**
        ...
        public void temperatureMeasured(String place, float temperature) {
            Float last = this.db.get(place);
            if (last== null || temperature > last){
                this.db.put(place,temperature);
                for (RecordObserver observer : this.observers) {
