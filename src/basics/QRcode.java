...
public class QRcode {
    ...
    public boolean equals(Object o) {
        ...
        boolean[][] temp_matrix = cast.data;
        if (Arrays.deepEquals(temp_matrix, this.data)){return true;}
        for (int i=0; i<3; i++){
            if (Arrays.deepEquals(this.data, temp_matrix = rotateMatrix(temp_matrix))){
                return true;
            }
        }
        return false;
